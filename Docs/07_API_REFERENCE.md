...
📚 **상세 가이드** : [보안 지표 가이드](<02_METRICS_REFERENCE.md>)
...
Agent Evaluator v0.6.6은 CrewAI, LangChain, LangGraph, AutoGen 등 주요 AI 프레임워크에 대한 고급 통합 기능을 제공합니다. 모든 통합은 **Layer 1/2/3 메트릭을 완전히 지원** 하며, 동적 계산 및 자동 추적 기능을 갖추고 있습니다.
...
## 참고 자료
  ...
  * [메트릭 가이드](<02_METRICS_REFERENCE.md>): 모든 평가 지표 상세 설명
  * [프레임워크 통합 가이드](<03_FRAMEWORK_GUIDE.md>): CrewAI, AutoGen 등 통합
  * [배포 가이드](<06_06_DEPLOYMENT_GUIDE.md>): FastAPI 대시보드 배포 (`agent-eval dashboard`)
