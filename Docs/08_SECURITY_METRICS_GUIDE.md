...
**프로덕션 준비 완료!**
  ...
  * ✅ **Layer 1 & 2 통합**: 보안 지표가 네이티브 메트릭에 완전 통합
...
**주요 기능:**
  ...
  * ✅ **Layer 1 보안 지표 (3개)** : 입력 살균, 출력 유출 탐지, 도구 권한 관리
  * ✅ **Layer 2 보안 지표 (2개)** : 권한 상승 탐지, 공격 패턴 탐지
...
계층 | 지표 수 | 탐지 대상 | 오버헤드 | 차단 가능  
---|---|---|---|---  
**Layer 1** | 3개 | Injection, 유출, 권한 위반 | ~5-10ms | ✅ 실시간  
**Layer 2** | 2개 | 권한 상승, 공격 체인 | ~1-2ms | ⚠️ 사후 분석  
...
## 📖 관련 문서
  ...
  * [API 레퍼런스](<API_REFERENCE.html>) \- 전체 API 문서 (v0.5.2)
  * [평가 지표 가이드](<METRICS_GUIDE.html>) \- Layer 1, 2, 3 지표 상세 (v0.5.2)
  * [고급 메트릭 가이드](<AGENTIC_AI_METRICS_GUIDE.html>) \- Layer 2 메트릭 완전 가이드 (v0.5.2)
