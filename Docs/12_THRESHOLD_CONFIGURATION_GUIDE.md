...
```json
    [](<#cb36-1>)// PerformanceMonitor 기본 임계값 (v0.5.7)
    [](<#cb36-2>){
...
**Layer 2 (Security Metrics)** ⚡ _v0.5.7_ :
...
Threshold 설정을 완료했다면:
  ...
  4. **프로덕션 배포** : [DEPLOYMENT_GUIDE.md](<DEPLOYMENT_GUIDE.md>) 참고
...
## 참고 문서
  ...
  * [GOLDEN_DATASET_GUIDE.md](<GOLDEN_DATASET_GUIDE.md>) \- Golden Dataset 작성 가이드
  * [AGENTIC_AI_METRICS_GUIDE.md](<AGENTIC_AI_METRICS_GUIDE.md>) \- Layer 2 메트릭 가이드
