...
pip install /home/fomalhaut/Projects/Agent_Evaluator/dist/agent_evaluator-0.5.6-py3-none-any.whl
...
#### ⚠️ 프로젝트 루트 파일
  ...
  * **dist/** : 빌드된 wheel/tar.gz (agent_evaluator-0.5.6-*)
...
**최종 업데이트** : 2026-03-20 | **버전** : Agent Evaluator v0.5.6
