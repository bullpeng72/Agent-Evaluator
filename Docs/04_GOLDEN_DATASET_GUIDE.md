...
테스트 데이터셋 생성 및 관리 (Agent Evaluator v0.6.6)
...
Golden Dataset 작성을 완료했다면:
  ...
  1. **임계값 설정** : [05_THRESHOLD_GUIDE.md](<05_THRESHOLD_GUIDE.md>) 참고
  2. **자동 평가 실행** : `Evaluator_Examples/04_threshold_validation_example.py` 실행
  3. **CI/CD 통합** : [06_DEPLOYMENT_GUIDE.md](<06_DEPLOYMENT_GUIDE.md>) 참고
...
## 참고 문서
  ...
  * [02_METRICS_REFERENCE.md](<02_METRICS_REFERENCE.md>) \- Layer 2 메트릭 완전 가이드
