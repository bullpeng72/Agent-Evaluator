...
| **Agent Evaluator** | OSS SDK | v0.5.3 (2026.03) | Agentic AI 전문 평가 |
...
| **Agent Evaluator** | OSS 로컬 | 4개 섹션 대시보드 (품질/성능/에이전틱/보안) | 도구선택/워크플로우/재시도/멀티에이전트/보안 전용 섹션 | ✅ (완전 로컬) | **무료** |
...
| **Agent Evaluator** | `agent-eval serve` CLI 1줄 | **1줄** |
