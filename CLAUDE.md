...
│   ├── ask_insights_mcp.py       # 결과 JSON의 insight 계층 조회 stdio MCP(--with-ask-insights). insights_summary/insights_readiness/insights_why_failed(task_id)/insights_list(filter)
